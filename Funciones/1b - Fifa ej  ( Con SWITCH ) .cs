...
namespace ConsoleApp68
{
        ...
        Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Pulse una letra para ir al menu ");
            Console.ReadKey();

            do
            {
                Console.WriteLine("1 -  Posible Campeon     ");
                Console.WriteLine("2 -  Tabla De Posiciones ");
                Console.WriteLine("3 -  No Lo Consigue      ");
                Console.WriteLine("4 -  ");
                ...
                switch (op)
                {
                    case 1:
                        ...
                        Console.WriteLine("Pulse una letra para volver al menu");
                        Console.ReadKey();
