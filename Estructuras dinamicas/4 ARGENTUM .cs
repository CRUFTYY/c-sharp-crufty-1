...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        static void ventast(ventas[] ventas1, int cantv)
        {
            ...
            for (int i = 0; i < cantv; i++)
            {
                ventas1[i].vent; = ventas1[i].vent + ventas[i].vent;
            }
        }
        static void Main(string[] args)
        {
            ...
            ventas[] ventas;
            ventas = new ventas[cantv];
            rec[] rec1;
            rec1 = new rec[cantr];

            pedir(ventas, rec1, cantr, cantv);
            do
            {
                ...
                {
                    case 1: 
                        ordenar(ventas, rec1, cantr, cantv);
                        break;

                    case 2: 
                        mejor(ventas, rec1, cantr, cantv);
                        break;

                    case 3: 
                        ventast(ventas, cantv); break;
