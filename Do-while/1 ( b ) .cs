...
namespace ConsoleApp1
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                switch (op)
                {
                    ...
                    case 2:
                        ...
                        optorta = int.Parse(Console.ReadLine());
                    ...
                    case 3:
                        ...
                        opalmuerzo = int.Parse(Console.ReadLine());
            ...
            while (op != 5);
            Console.WriteLine("         ╔═══════════════════════════════════════════╗");
            Console.WriteLine("         ║       Esto es lo que usted pidio          ║");
            Console.WriteLine("         ╚═══════════════════════════════════════════╝");
            Console.WriteLine("");
            Console.WriteLine("");
            Console.WriteLine(          "Pediste:  " + cafe + " , " + torta + " , " + almuerzo + "  y  " + bebida);
